...
/** Passage-level citability target for data-speakable blocks. */
export const SPEAKABLE_MIN_WORDS = 130;
export const SPEAKABLE_MAX_WORDS = 170;

export function speakableWordCount(text: string) {
...
export function areaList(locale: Locale = "en") {
  ...
  return touristAreas.join(", ").replace(/, ([^,]*)$/, ", and $1");
}
