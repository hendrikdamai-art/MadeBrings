...
const en = {
  ...
  blogCommercialKicker: "Book from Abianbase",
  blogCommercialTitle: "High-intent delivery guides",
  blogEditorialTitle: "Holiday notes",
  footerBlurb:
...
const id: { [K in keyof typeof en]: string } = {
  ...
  blogCommercialKicker: "Pesan dari Abianbase",
  blogCommercialTitle: "Panduan antar berniat beli",
  blogEditorialTitle: "Catatan liburan",
  footerBlurb:
  ...
  blogIndexTitle: "Blog",
  blogIndexBody:
    "Mulai dari antar alkohol di Canggu, Seminyak, Kuta, Ubud, dan Tanah Lot — lalu catatan liburan Bali, pemandu wisata, dan arak. Chat dulu untuk konfirmasi pesanan.",
  catBeer: "Bir & sider",
